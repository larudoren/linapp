...
<a href="<?php echo base_url();?>index.php/stock_opname/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>index.php/stock_opname">
Date <input type="text" name="cari_tgl" id="cari_tgl" size="15" />
&nbsp;&nbsp;&nbsp; Search Stock ID : <input type="text" name="txt_cari" id="txt_cari" size="50" />
...
<?php
	if($data->num_rows()>0){
		...
		?>    
    	<tr>
            <td align="center" width="100" ><?php echo $db['stock_id']; ?></td>
			...
			?>
            <a href="<?php echo base_url();?>index.php/stock_opname/edit/<?php echo $db['stock_id'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/stock_opname/hapus/<?php echo $db['stock_id'];?>"
