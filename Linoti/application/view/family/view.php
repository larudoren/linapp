...
<form name="form" method="post" action="<?php echo base_url();?>index.php/family">
Code & Family : <input type="text" name="txt_cari" id="txt_cari" size="50" />
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/family/edit/<?=$db['family_id']?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/family/hapus/<?=$db['family_id']?>"
