<form name="multiform" id="multiform" action="<?=site_url('import_upholstery/import/'.$id_cotation)?>" method="POST" enctype="multipart/form-data">
<fieldset class="atas">
...
<tr>
	...
	<a href="<?=site_url('import_upholstery')?>">
