...
<div title="Master" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
	...
	<a href="<?php echo base_url();?>index.php/tipebarang">Tipe Barang</a>
    </li>
    <li data-options="iconCls:'icon-surat_keputusan'">
...
<div title="PPIC" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    <div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
    <ul class="easyui-tree">
    <li data-options="iconCls:'icon-surat_keputusan'">
	...
	<li data-options="iconCls:'icon-surat_keluar'">
    <a href="<?php echo base_url();?>index.php/penerimaan_barang">Penerimaan Barang</a>
    </li>
    <li data-options="iconCls:'icon-surat_keluar'">
    <a href="<?php echo base_url();?>index.php/pengeluaran_barang">Pengeluaran Barang</a>
    </li>
    </ul>
    </div>
</div>
<div title="Upload" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li>
    <span><a href="<?php echo base_url();?>index.php/import_barang">Master Barang</a></span>
    </li>
    </ul>
    </div>
</div>
