...
<div class="blok_header">
    <div class="header">
      ...
      <img src="<?php echo base_url();?>asset/images/chakranaga.jpg" width="85" height="71" border="0" alt="logo" /></a>
      </div>-->
      <div class="judul">
...
<fieldset>
    ...
    <tr>
    	<td>Username</td>
        <td>:</td>
		<td><input type="text" name="username" value="<?=$this->input->cookie('username')?>"></td>
	</tr>
    <tr>       
		<td>Password</td>
        <td>:</td>
		<td><input type="password" name="password" value="<?=$this->input->cookie('password')?>"></td>
	</tr>
	<tr>       
		<td>Location</td>
        <td>:</td>
		<td>&nbsp;
			<select name="location" id="location"> 
				...
				<option value="10000" selected="selected">Jepara</option>
			</select>
		</td>
	</tr>
	<tr>       
...
<div id="footer" align="center">
	<p>Copyright &copy; <?php echo $instansi;?> 2014</p>
