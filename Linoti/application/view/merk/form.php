...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/merk/simpan",
			data	: string,
			cache	: false,
...
<tr>    
	<td>Merk</td>
    <td>:</td>
    <td><input type="text" name="merk" id="merk" size="60" class="easyui-validatebox" data-options="required:true" value="<?=$merk?>"/></td>
</tr>
</table>
</fieldset>
