...
?>
<a href="<?php echo base_url();?>index.php/merk/tambah">
...
<form name="form" method="post" action="<?php echo base_url();?>index.php/merk">
Code & Merk : <input type="text" name="txt_cari" id="txt_cari" size="50" />
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/merk/edit/<?=$db['merk_id']?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/merk/hapus/<?=$db['merk_id']?>"
            onClick="return confirm('Do you want to delete the this data?')">
