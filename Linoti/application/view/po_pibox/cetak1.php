				...
				<td>
					<table>
						...
						<tr>
							...
							<th colspan="3" rowspan="2" align="center" bgcolor="#92D050">Comercial<br/>Size(mm)</td>
							<th rowspan="3" align="center" bgcolor="#CCC0DA">Knock<br/>Down<br/>?</td>
							<th rowspan="3" align="center" width="40" bgcolor="#808000">Packaging</td>
							<?php if ($lshape1==1) {?>
							<th colspan="18" align="center" bgcolor="#C5BE97">Box 1</td>
							<?php } else { ?>
							<th colspan="16" align="center" bgcolor="#C5BE97">Box 1</td>
							<?php } ?>
							<th rowspan="3" align="center" width="25" bgcolor="#C5BE97">Vol. Outer<br/>/ Item<br>( m<sup>3</sup> )</td>
							<th rowspan="2" align="center" width="40" bgcolor="#66FFFF">Unit<br/>Price</td>
							<th rowspan="3" align="center" width="40" bgcolor="#66FFFF">Total<br/>Price<br>/ Item</td>
						...
						<tr>
							...
							<th colspan="3" bgcolor="#FDE9D9">Inner Size (mm)</th>
							<th colspan="3" bgcolor="#C5BE97">+ Carton</th>
							<th colspan="3" bgcolor="#FDE9D9">Outer Size (mm)</th>
							<?php if ($lshape1==1){ ?>
							<th rowspan="2" bgcolor="#C5BE97">L<br>Vert.</th>
							<th rowspan="2" bgcolor="#C5BE97">L<br>Hori.</th>
							<?php } ?>
						...
						<tr>
							<?php if ($lshape1==1 /*&& $lshape2==1*/) {?>
							<!--<td colspan="50">-->
							<?php //}else if (($lshape1==1 && $lshape2!=1)||($lshape1!=1 && $lshape2==1)) {?>
							<td colspan="48">
							<?php } else { ?>
							<td colspan="46">
							<?php } ?>
						...
						<tr>
							...
							<?php } 
								//  if($lshape2==1) {
							?>
							<!--<th colspan="18" align="center" bgcolor="#C5BE97">Box 2</td>-->
							<?php //} else { ?>
							<th colspan="16" align="center" bgcolor="#C5BE97">Box 2</td>
							<?php //} ?>
							<!--<th rowspan="3" align="center" bgcolor="#C5BE97">Total<br>Vol. Box<br/>Outer<br/>Box 1</td>-->
							<!--<th rowspan="3" align="center" bgcolor="#C5BE97">Total<br>Vol. Box<br/>Outer<br/>Box 2</td>-->
							<th rowspan="3" align="center" width="15" bgcolor="#C5BE97">Vol. Outer<br>/Item<br>( m<sup>3</sup> )</td>
							<th rowspan="2" colspan="2" align="center" width="60" bgcolor="#66FFFF">Unit<br/>Price</td>
							<th rowspan="3" align="center" width="25" bgcolor="#66FFFF">Total<br/>Price<br>/ Item</td>
						...
						<tr>
							...
							<th colspan="3" bgcolor="#FDE9D9">Outer Size (mm)</th>
							<?php if($lshape1==1){ ?>
							<th rowspan="2" bgcolor="#C5BE97">L Vert.</th>
							<th rowspan="2" bgcolor="#C5BE97">L Hori.</th>
							<?php } ?>
							<th rowspan="2" bgcolor="#C5BE97">Vol. Outer<br> / pcs</th>
						...
						<tr>
							<th bgcolor="#92D050">L</th> <!-- Commercial Size -->
							<th bgcolor="#92D050">W</th> <!-- Commercial Size -->
							<th bgcolor="#92D050">H</th> <!-- Commercial Size -->
							<th bgcolor="#C5BE97"></th> <!-- Type Box 1-->
							<th bgcolor="#C5BE97">L</th> <!-- Gap Box 1-->
							<th bgcolor="#C5BE97">W</th> <!-- Gap Box 1-->
							<th bgcolor="#C5BE97">H</th> <!-- Gap Box 1-->
							<th bgcolor="#FDE9D9">L</th> <!-- Inner Size Box 1-->
							<th bgcolor="#FDE9D9">W</th> <!-- Inner Size Box 1-->
							<th bgcolor="#FDE9D9">H</th> <!-- Inner Size Box 1-->
							<th bgcolor="#C5BE97">L</th> <!-- +Carton Box 1-->
							<th bgcolor="#C5BE97">W</th> <!-- +Carton Box 1-->
							<th bgcolor="#C5BE97">H</th> <!-- +Carton Box 1-->
							<th bgcolor="#FDE9D9">L</th> <!-- Outer Size Box 1-->
							<th bgcolor="#FDE9D9">W</th> <!-- Outer Size Box 1-->
							<th bgcolor="#FDE9D9">H</th> <!-- Outer Size Box 1-->
							<th bgcolor="#C5BE97"></th>
							<th bgcolor="#C5BE97">L</th>
							<th bgcolor="#C5BE97">W</th>
							<th bgcolor="#C5BE97">H</th>
						...
						<?php } elseif ($box1==1 && $box2==1 && $box3==1) { ?>
						<tr>
							<?php if ($lshape1==1 && $lshape2==1 && $lshape3==1) {?>
							<td colspan="69">
							<?php } else if (($lshape1==1 && $lshape2==1 && $lshape3!=1)||($lshape1==1 && $lshape2!=1 && $lshape3==1)||($lshape1!=1 && $lshape2==1 && $lshape3==1)) {?>
							<td colspan="67">
							<?php } else if (($lshape1==1 && $lshape2!=1 && $lshape3!=1)||($lshape1!=1 && $lshape2!=1 && $lshape3==1)||($lshape1!=1 && $lshape2==1 && $lshape3!=1)) {?>
							<td colspan="65">
							<?php } else { ?>
						...
						<tr>
							...
							<th colspan="3" rowspan="2" align="center" bgcolor="#92D050">Comercial<br/>Size(mm)</td>
							<th rowspan="3" align="center" bgcolor="#CCC0DA">Knock<br/>Down<br/>?</td>
							<th rowspan="3" align="center" width="20" bgcolor="#808000">Packaging</td>
							<?php if($lshape1==1){ ?>
							<th colspan="18" align="center" bgcolor="#C5BE97">Box 1</td>
							<?php } else { ?>
							<th colspan="16" align="center" bgcolor="#C5BE97">Box 1</td>
							...
							<?php } 
								if($lshape3==1){ ?>
							<th colspan="18" align="center" bgcolor="#C5BE97">Box 3</td>
							<?php } else { ?>
							<th colspan="16" align="center" bgcolor="#C5BE97">Box 3</td>
							<?php } ?>
							<!--<th rowspan="3" align="center" bgcolor="#C5BE97">Total<br>Vol. Box<br/>Outer<br/>Box 1</td>
							<th rowspan="3" align="center" bgcolor="#C5BE97">Total<br>Vol. Box<br/>Outer<br/>Box 2</td>
							<th rowspan="3" align="center" bgcolor="#C5BE97">Total<br>Vol. Box<br/>Outer<br/>Box 3</td>-->
							<th rowspan="3" align="center" width="15" bgcolor="#C5BE97">Vol. Outer<br>/ Item<br>( m<sup>3</sup> )</td>
							<th rowspan="2" colspan="3" align="center" width="70" bgcolor="#66FFFF">Unit<br/>Price</td>
							<th rowspan="3" align="center" width="25" bgcolor="#66FFFF">Total<br/>Price<br>/ Item</td>
							<th rowspan="2" align="center" width="20" bgcolor="#66FFFF">Update</td>
						</tr>
						<tr>
							...
							<?php if($lshape1==1){ ?>
							<th rowspan="2" bgcolor="#C5BE97">L Vert</th>
							<th rowspan="2" bgcolor="#C5BE97">L Hor</th>
							<?php } ?>
							<th rowspan="2" bgcolor="#C5BE97">Vol. Outer<br> / pcs</th>
							<th rowspan="2" bgcolor="#FDE9D9">Qty Box 1</th>
							<th rowspan="2" bgcolor="#FDE9D9">Remarks Box 1</th>
							<th bgcolor="#C5BE97">Type</th>
							<th colspan="3" bgcolor="#C5BE97">Gap</th>
							<th colspan="3" bgcolor="#FDE9D9">Inner Size</th>
							<th colspan="3" bgcolor="#C5BE97">+ Carton</th>
							...
							<th rowspan="2" bgcolor="#C5BE97">Vol. Outer<br> / pcs</th>
							<th rowspan="2" bgcolor="#FDE9D9">Qty Box 2</th>
							<th rowspan="2" bgcolor="#FDE9D9">Remarks Box 2</th>
							<th bgcolor="#C5BE97">Type</th>
							<th colspan="3" bgcolor="#C5BE97">Gap</th>
							<th colspan="3" bgcolor="#FDE9D9">Inner Size</th>
							<th colspan="3" bgcolor="#C5BE97">+ Carton</th>
							...
							<th rowspan="2" bgcolor="#FDE9D9">Remarks Box 3</th>
						</tr>
						<tr>
						...
						?>
								<tr>
									...
									<td align="center">
										<!--<div style="width: 60px; height: 60px; border: no; overflow: hidden; position: relative;">-->
											<?php 
												if ($width >= $height){ 
						...
						<?php
									if ($dataresult->cm_length > 0){
										$whole = 0;
										$fraction = 0.0;
										$whole = floor($dataresult->cm_length*10);
										$fraction = ($dataresult->cm_length*10) - $whole;
										if ($fraction > 0){
						?>
											<td align="center"><?=number_format($dataresult->cm_length*10,1,'','')?></td>
						<?php
										} else {
						?>
											<td align="center"><?=number_format($dataresult->cm_length*10,0,'','')?></td>
						<?php
										}
									} else {
						?>
						...
						<?php
									...
									if ($dataresult->cm_width > 0){
										$whole = 0;
										$fraction = 0.0;
										$whole = floor($dataresult->cm_width*10);
										$fraction = ($dataresult->cm_width*10) - $whole;
										if ($fraction > 0){
						?>
											<td align="center"><?=number_format($dataresult->cm_width*10,1,'','')?></td>
						<?php
										} else {
						?>
											<td align="center"><?=number_format($dataresult->cm_width*10,0,'','')?></td>
						<?php
										}
									} else {
						?>
						...
						<?php
									...
									if ($dataresult->cm_height > 0){
										$whole = 0;
										$fraction = 0.0;
										$whole = floor($dataresult->cm_height*10);
										$fraction = ($dataresult->cm_height*10) - $whole;
										if ($fraction > 0){
						?>
											<td align="center"><?=number_format($dataresult->cm_height*10,1,'','')?></td>
						<?php
										} else {
						?>
											<td align="center"><?=number_format($dataresult->cm_height*10,0,'','')?></td>
						<?php
										}
									} else {
						?>
						...
						<?php
									...
									$textdetail = "SELECT E.boxnumber, E.kdown, E.remarks_packing, E.remarks, E.lstyrofoam, E.wstyrofoam, E.hstyrofoam, E.linner, E.winner, E.hinner, E.lkarton, E.wkarton, E.hkarton, E.louter,E.wouter, 
																				E.houter, E.volouter, A.qtybox, E.qtyperbox,E.typebox, F.currency_name, A.hrgbox, DATE_FORMAT(A.hrgdate,'%d-%b-%y') as hrgdate, E.asize, E.bsize, E.qtybox as qtyboxitem
																 FROM d_belibox A
									...
									if ($row>0){
										...
										foreach ($table->result() as $dt){
											if ($box1==1 && $box2!=1 && $box3!=1){
												...
												$volboxitem1 = $dt->volouter*$dt->qtyboxitem;
												$qtyboxitem1 = $dt->qtyboxitem;
						...
						<?php
												if ($dt->linner >0 ){
													...
													if ($dataresult->cm_length*10!=($dt->linner-$dt->lstyrofoam)){
						...
						<?php
												...
												if ($dt->winner >0 ){
													...
													if ($dataresult->cm_width*10!=($dt->winner-$dt->wstyrofoam)){
							...
							<?php
												...
												if ($dt->hinner >0 ){
													...
													if ($dataresult->cm_height*10!=($dt->hinner-$dt->hstyrofoam)){
							...
							?>
												<td align="center"><?=number_format($dt->volouter,3,',','')?></td>
							...
							<?php
													...
													$volboxitem2 = $dt->volouter*$dt->qtyboxitem;
													$qtyboxitem2 = $dt->qtyboxitem;
													$hrg2 = $dt->hrgbox;
												}
							?>
												<td align="center"><?=$dt->typebox?></td>
							...
							<?php
												...
												if ($lshape1==1 && $dt->boxnumber=='BOX 1'){
													if ($dt->asize > 0){
														$whole = 0;
														$fraction = 0.0;
														$whole = floor($dt->asize);
							...
							<?php
													...
													$volboxitem3 = $dt->volouter*$dt->qtyboxitem;
													$qtyboxitem3 = $dt->qtyboxitem;
													$hrg3 = $dt->hrgbox;
												}
							?>
												<td align="center"><?=$dt->typebox?></td>
							...
							<?php
												...
												if (($lshape1==1 && $dt->boxnumber=='BOX 1')||($lshape2==1 && $dt->boxnumber=='BOX 2')||($lshape3==1 && $dt->boxnumber=='BOX 3')){
													if ($dt->asize > 0){
														$whole = 0;
														$fraction = 0.0;
														$whole = floor($dt->asize);
							...
							<?php
										...
										if ($box1==1 && $box2!=1 && $box3!=1){
							?>
											<td align="center"><?=number_format($volboxitem1,3,',','')?></td>
							<?php
											//if ($hrg1>0){
							?>
												<td align="center"><?=$currency.'  '.number_format($hrg1,0,'','.')?></td>
												<td align="center"><?=$currency.'  '.number_format($hrg1*$qtyboxitem1,0,'','.')?></td>
							<?php
											//} else {
							?>
											<!--	<td></td>-->
							...
							?>
											...
											<td align="center"><?=number_format(($volboxitem1+$volboxitem2),3,',','')?></td>
							<?php
											//if ($hrg1>0){
							?>
												<td align="center"><?=$currency.'  '.number_format($hrg1,0,'','.')?></td>
							...
							?>
												...
												<td align="center"><?=$currency.'  '.number_format(($hrg1*$qtyboxitem1)+($hrg2*$qtyboxitem2),0,'','.')?></td>
							<?php
											//} else {
							?>
											<!--	<td></td>-->
							...
							?>
											...
											<td align="center"><?=number_format(($volboxitem1+$volboxitem2+$volboxitem3),3,',','')?></td>
							<?php
							...
							?>
												...
												<td align="center"><?=$currency.'  '.number_format(($hrg1*$qtyboxitem1)+($hrg2*$qtyboxitem2)+($hrg3*$qtyboxitem3),0,'','.')?></td>
							<?php
											//} else {
							?>
											<!--	<td></td>-->
